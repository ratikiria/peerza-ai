...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('FOLLOW', 'CONNECTION_REQUEST', 'CONNECTION_ACCEPTED', 'POST_LIKE', 'POST_COMMENT', 'POST_SHARE', 'MESSAGE', 'CALL');

-- CreateEnum
CREATE TYPE "SubscriptionPlan" AS ENUM ('THREE_MONTHS', 'SIX_MONTHS', 'TWELVE_MONTHS');
...
-- AddForeignKey
ALTER TABLE "Notification" ADD CONSTRAINT "Notification_triggeredBy_fkey" FOREIGN KEY ("triggeredBy") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
